...
public final class ItemBanPredicate implements BiPredicate<ItemStack, Player> {
    public static final Codec<ItemBanPredicate> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    Codec.STRING.listOf().optionalFieldOf("groups", new ArrayList<>()).forGetter(ItemBanPredicate::groups)
    ...
    public ItemBanPredicate(ItemPredicate itemPredicate, List<String> groupKeys) {
